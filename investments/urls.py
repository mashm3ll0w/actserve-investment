...
urlpatterns = [
    ...
    path('investment_accounts/<int:account_id>/transactions/<int:transaction_id>', views.UserTransactionsUpdateAndDestroyView.as_view(), name='update_or_destroy_transaction'),
